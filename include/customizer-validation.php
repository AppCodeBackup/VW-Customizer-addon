 ...
 */
function themes_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function themes_sanitize_select( $input, $setting ) {
...
function themes_sanitize_select_font( $input, $setting ) {
  global $wp_customize;
 ...
 * @version 1.2.2
 */
function themes_sanitize_image( $image, $setting ) {
