...
if ( ! class_exists( 'Remote_Dashboard_Notifications_Client' ) ) {
	...
	final class Remote_Dashboard_Notifications_Client {
      ...
      // var_dump( get_transient( 'themes_rdn_fetch_notifications' ) );

      if ( false === get_transient( 'themes_rdn_fetch_notifications' ) ) {      
      ?>
      ...
      set_transient( 'themes_rdn_fetch_notifications', 'rdn_fetch_notifications', 604800 ); 
