...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class themes_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		...
		public function enqueue(){
			wp_enqueue_style( 'themes_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'css/controls/customizer.css', array(), '1.0', 'all' );
		}
		/**
	...
	class themes_Image_Radio_Control extends WP_Customize_Control {
