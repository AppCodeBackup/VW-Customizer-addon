...
class themes_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="total-icon-list clearfix">
                    ...
                    <?php
                    $themes_font_awesome_icon_array = themes_font_awesome_icon_array();
                    foreach ($themes_font_awesome_icon_array as $themes_font_awesome_icon) {
                            $icon_class = $this->value() == $themes_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($themes_font_awesome_icon).'"></i>
                            <span class="vw-social-class">'.esc_attr($themes_font_awesome_icon).'</span></li>';
                        }
                    ?>
                </ul>
...
function themes_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', CUSTOM_DIR_URL . 'classes/controls/social-icons/css/font-awesome.css', array(), '' ); 
    wp_enqueue_style( 'total-customizer-style', CUSTOM_DIR_URL . 'classes/controls/social-icons/css/customizer-style.css', array(), '' ); 
    wp_enqueue_script( 'total-customizer-script', CUSTOM_DIR_URL . 'classes/controls/social-icons/js/customizer-scripts.js', array( 'jquery'),'');
    
}
add_action( 'customize_controls_enqueue_scripts', 'themes_customizer_script' );

if(!function_exists('themes_font_awesome_icon_array')){
    function themes_font_awesome_icon_array(){
