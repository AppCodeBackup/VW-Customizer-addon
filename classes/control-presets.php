...
* @access public
*/
class Themes_Setting_Presets extends WP_Customize_Control {
      ...
      <?php foreach ( $this->choices as $val ) : ?>
        ...
        <div class="themes_thumbnail">
          ...
          <label for="<?php echo $this->id . $val['id']; ?>">
            <div class="themes_thumbnail_img">
...
function themes_presets_control_css() {
  ?>
  <style>
...
#customize-control-customize_presets_settings .themes_thumbnail{
  width: calc(50% - 10px);
  margin-bottom: 10px;
  position: relative;
...
#customize-control-customize_presets_settings .themes_thumbnail:nth-child(odd){
  float: left;
}
#customize-control-customize_presets_settings .themes_thumbnail:nth-child(even){
  float: right;
}
...
#customize-control-customize_presets_settings label .themes_thumbnail_img:after {
  content: '';
  width: 20px;
  height: 20px;
  border-radius: 50%;
...
#customize-control-customize_presets_settings label .themes_thumbnail_img:before {
  height: 6px;
  width: 3px;
...
#customize-control-customize_presets_settings .themes_thumbnail_img{
  display: block;
  position: relative;
}
#customize-control-customize_presets_settings input[type="radio"]:checked + label .themes_thumbnail_img:before {
...
#customize-control-customize_presets_settings input[type="radio"]:checked + label .themes_thumbnail_img:after{
  visibility: visible;
}
/*#customize-control-customize_presets_settings input[type="radio"]:disabled + label .themes_thumbnail_img:before{
  visibility: hidden;
}
#customize-control-customize_presets_settings input[type="radio"]:disabled + label .themes_thumbnail_img:after{
  visibility: hidden;
}*/
...
#customize-control-customize_presets_settings .themes_thumbnail:hover input[type="radio"]:disabled ~ .no-available{
  opacity: 1;
  visibility: visible;
  color: #000;
...
#customize-control-customize_presets_settings .themes_thumbnail:hover{
  border-color: #ccc;
}
...
add_action( 'customize_controls_print_styles', 'themes_presets_control_css' );
?>
